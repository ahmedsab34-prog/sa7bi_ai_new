...
class ProfileActions extends StatelessWidget {
  ...
  void _openGeneralAi(BuildContext context) {
    Navigator.push(
      context,
      MaterialPageRoute(
  ...
  void _openKhalasana(BuildContext context) {
    Navigator.push(
      context,
      MaterialPageRoute(
  ...
  Widget build(BuildContext context) {
    final tools = <_ProfileTool>[
      _ProfileTool(
        ...
        onTap: () => _openGeneralAi(context),
      ),

      _ProfileTool(
        icon: Icons.image_rounded,
        title: 'إنشاء صورة',
        subtitle: 'توليد وتعديل',
      ...
      _ProfileTool(
        ...
        title: 'خلصانة AI',
        subtitle: 'كل الأدوات',
        color: const Color(0xFF8EA8FF),
        onTap: () => _openKhalasana(context),
      ),
      ...
      _ProfileTool(
        ...
        onTap: () => _showServices(context),
      ),

      _ProfileTool(
        icon: Icons.share_rounded,
        title: 'مشاركة',
        subtitle: 'رابط التطبيق',
...
class _ToolsTitle extends StatelessWidget {
  const _ToolsTitle();
